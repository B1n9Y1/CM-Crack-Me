...
auto getNetworkInfo()
{
	...
	if (ret == ERROR_SUCCESS)
	{
		...
		while (pIpAdapterInfo)
		{
			...
			retrun_info[0] = pIpAdapterInfo->AdapterName;
			retrun_info[1] = pIpAdapterInfo->Description;
